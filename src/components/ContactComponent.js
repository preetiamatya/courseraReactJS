...
class Contact extends Component {
  constructor (props) {
    super(props);
    {/*property should be same as the name of the html elements*/}
    {/*track the state if the firstname etc.. has been touched*/}
    this.state = {
      firstname:'',
      lastname: '',
      telnum: '',
  ...
  handleInputChange(event) {
    ...
    {/*any change made in form is reflected in the state*/}
    this.setState ({
      [name]:value
    });
  }
  ...
  handleBlur = (field) => (evt) => {
    {/*method that indicates which particular field has been modified*/}
    this.setState ({
